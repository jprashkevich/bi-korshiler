...
export const SPACES = [
  { id: 'ala-egizbaeva',     name: 'Egizbaeva',             city: 'Алматы' },
  { id: 'ala-momyshuly',     name: 'Momyshuly',             city: 'Алматы' },
  { id: 'ast-arena-garden',  name: 'Arena Garden',          city: 'Астана' },
  { id: 'ast-aurora',        name: 'GreenLine Aurora',      city: 'Астана' },
  { id: 'ast-emotions',      name: 'Capital Park Emotions', city: 'Астана' },
  { id: 'ast-flagman',       name: 'Flagman',               city: 'Астана' },
  { id: 'ast-flora',         name: 'GreenLine Flora',       city: 'Астана' },
  { id: 'ast-grand-turan',   name: 'Grand Turan',           city: 'Астана' },
  { id: 'ast-nexpo-classic', name: 'Nexpo Classic',         city: 'Астана' },
  { id: 'ast-nexpo-trend',   name: 'Nexpo Trend',           city: 'Астана' },
  { id: 'ast-qasteev',       name: 'Qasteev',               city: 'Астана' },
  { id: 'atr-abulkhair',     name: 'Abulkhair',             city: 'Атырау' },
  { id: 'atr-taimanov',      name: 'Taimanov',              city: 'Атырау' },
];
